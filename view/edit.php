...
?>
    ...
    <form class="container" method="POST" action="./../controller/updateuser.php?id=<?php echo  $user["id"]?>" enctype="multipart/form-data"> 
        <div class="form-group my-3">
            <label for="name"> Name</label>
            <input type="text" class="form-control" name="name" value="<?php echo $user["name"]?$user["name"]:'' ?>"  id="firstName" placeholder="Enter name">
            <!-- <div class="text-danger"> <?php echo $name_error?> </div> -->
        </div>
        
       <div class="form-group my-3">
            <label for="username">email</label>
            <input type="text" class="form-control" name="email" value="<?php echo $user["email"]?$user["email"]:'' ?>" placeholder="Enter email">
